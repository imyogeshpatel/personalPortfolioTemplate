      ...
      <div className="container">
        <div className='flex flex-col items-center'> 
          ...
          <div className='bg-gray-950 border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg'>
            ...
            <div className='text-sm font-medium'>Available for new peojects</div>
          </div>
        </div>

        <div className='max-w-lg mx-auto'>
          <h1 className='font-serif text-3xl md:5xl text-center mt-8 tracking-wide'>Building Exceptional User Experiences</h1>

          <p className='mt-4 text-center text-white/60 md:text-lg'>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit, quod? Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, eius.
          </p>
        </div>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
          ...
          <button className='inline-flex items-center gap-2 border-2 border-white bg-white text-gray-900 h-12 px-6 rounded-xl'>
            <span>👋</span>
